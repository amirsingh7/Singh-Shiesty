...
/**
 * The Mentor — Gobind, minimal. When the mentor is clicked everything else
 * fades away and this remains:
 *
 *        ───────── ai mentor ─────────      (top centre, big, animated in)
 *            [ pick your goal ]             (easy in and out)
 *              chat with gobind             (suggested prompts, then a real reply)
 *
 * The goal switcher still drives the accent color and chat context; the old
 * static weights/notices/goal-box card was retired in favor of just asking
 * Gobind directly.
 */
