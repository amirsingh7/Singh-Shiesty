    ...
    <main className={`${styles.page} ${styles.oneScreen} grain-overlay`} style={{ ['--wall-accent' as string]: wallAccent }}>
      ...
      <div className={styles.shell}>
        <div className={styles.headerRow}>
          ...
          {/* Profile (top-right): the Athletic Profile page — real navigation, not a
              modal, same as the mentor tile's <a href="/mentor">. Rendered before the
              settings gear so the gear sits at the very outer edge, furthest from the
              greeting — the icon most likely to collide with a long wrapped name is the
              one pushed furthest away from it. */}
          <a
            href="/profile"
          ...
          {/* Settings gear (top-right, outermost): opens the scratch panel — the way in, and back. */}
          <div
            className={styles.profileAvatar}
            onClick={() => setScratchOpen(true)}
            role="button"
